...
<html lang="en">
  ...
  <div class="container d-flex flex-column flex-md-row justify-content-between">
    <a class="py-2 d-none d-md-inline-block" href="officialhome.php">Home</a>
...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
  <div class="col-md-5 p-lg-5 mx-auto my-5">
    ...
    their data.</p>
    <a class="btn btn-outline-secondary" href="login.php">Get your account today.</a>
  </div>
...
<div class="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3">
  ...
  <div class="bg-light mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
    <div class="my-3 p-3">
      <h2 class="display-5">Easy to use.</h2>
      <p class="lead">Even beginners will enjoy.</p>
    </div>
    <div class="bg-dark shadow-sm mx-auto" style="width: 80%; height: 300px; border-radius: 21px 21px 0 0;">
      <img src="FE/images/easy_touse.png" alt="">
    </div>
  </div>
</div>
...
<div class="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3">
  <div class="bg-light mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
    <div class="my-3 p-3">
      <h2 class="display-5">Secure system</h2>
      <p class="lead">All farmers data is protected and stored with an authentication system.</p>
    </div>
    <div class="bg-dark shadow-sm mx-auto" style="width: 80%; height: 300px; border-radius: 21px 21px 0 0;">
      <img src="FE/images/security_camera.png" alt="">
    </div>
  </div>
</div>
...
<?php /**PATH C:\Users\pavilion X360\Desktop\gitProjects\MisuliTinginya\resources\views/FE/welcome.blade.php ENDPATH**/ ?>