...
<br>
          <div class="row">
              ...
              <div class="col-md-6">
              <form enctype="multipart/form-data" role="form" method="POST" action="<?php echo e(URL::to('expenses/update')); ?>">
                  <?php echo csrf_field(); ?>
                  <input type="hidden" value="<?php echo e($expensesEdit->expenses_id); ?>" name="expenses_id" />
                  <div class="form-group row">
                      <div class="col-sm-6 mb-3 mb-sm-0">
                          <input value="<?php echo e($expensesEdit->expenses_name); ?>" type="text" class="form-control form-control-user" id="expenseName" name="expenseName" placeholder="Name" required>
                      </div>
                      <div class="col-sm-6">
                          <input value="<?php echo e($expensesEdit->expenses_date); ?>" type="date" class="form-control form-control-user" id="expenseDate" name="expenseDate" placeholder="Date" required>
                      </div>
                  </div>
                  <div class="form-group">
                      <input value="<?php echo e($expensesEdit->expenses_description); ?>" type="text" class="form-control form-control-user" id="expenseDescription" name="expenseDescription" placeholder="Short Description" required>
                  </div>
                  <div class="form-group row">
                      <div class="col-sm-6 mb-3 mb-sm-0">
                          <input value="<?php echo e($expensesEdit->expenses_cost_per_unit); ?>"type="number" class="form-control form-control-user" id="expenseAmount" name="expenseAmount" placeholder="Cost per unit " required>
                      </div>
                      <div class="col-sm-6 mb-3 mb-sm-0">
                          <input value="<?php echo e($expensesEdit->expenses_quantity); ?>"type="number" class="form-control form-control-user" id="expenseQuantity" name="expenseQuantity" placeholder="quantity" required>
                      </div>
